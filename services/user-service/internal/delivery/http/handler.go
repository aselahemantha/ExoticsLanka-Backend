...
import (
	...
	"github.com/aselahemantha/exoticsLanka/services/user-service/internal/domain"
...
func (h *ProfileHandler) RegisterRoutes(router *gin.Engine, authMiddleware *AuthMiddleware) {
